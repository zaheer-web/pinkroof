    ...
    bg-gradient-to-br from-white via-pink-100 to-pink-300">
      ...
      <div className="flex flex-col justify-center px-6 md:px-12 lg:px-20 py-12 relative">
        ...
        <div className="relative z-10">
          ...
          {/* HEADING */}
          <h1 className="font-serif text-[2.5rem] md:text-[3.5rem] lg:text-[3.5rem] leading-tight text-black mb-6">
            Creative Spaces <br />
          ...
          {/* UPDATED DESCRIPTION */}
          <p className="text-base md:text-lg lg:text-lg leading-relaxed max-w-xl mb-10 text-black font-medium">
